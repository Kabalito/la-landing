...
const teamData = ref([
  { name: 'Roberto', position: 'Jefe de Flota', image: teamPerson1, backgroundColor: 'rgba(144, 85, 253, 0.16)', borderColor: 'rgba(144, 85, 253,0.16)', isHover: false },
  { name: 'Sofía', position: 'Experience Manager', image: teamPerson2, backgroundColor: 'rgba(22, 177, 255, 0.16)', borderColor: 'rgba(22, 177, 255,0.16)', isHover: false },
  { name: 'Miguel', position: 'Check-in Express', image: teamPerson3, backgroundColor: 'rgba(255, 76, 81, 0.16)', borderColor: 'rgba(255, 76, 81,0.16)', isHover: false },
  { name: 'Equipo GO DRIVER', position: 'Tu Pit Crew', image: teamPerson4, backgroundColor: 'rgba(86, 202, 0, 0.16)', borderColor: 'rgba(86, 202, 0,0.16)', isHover: false },
])
</script>
        ...
        <h4 class="d-flex align-center text-h4 mb-1 flex-wrap justify-center">
          <div class="position-relative me-2">
            <div class="section-title">
              Conoce al equipo detrás de GO DRIVER
            </div>
          </div>
        </h4>

        <p class="text-center text-body-1 mb-0">
          ¿Quién te guiará en tu próximo viaje?
        </p>
      </div>
