    ...
    <div class="contact-us-section">
      <div class="headers d-flex justify-center flex-column align-center pb-16">
        ...
        <p class="text-body-1 mb-0">
          ¿Necesitas asistencia en carretera o tienes una duda específica?
        </p>
      </div>
        ...
        <VRow class="match-height">
                  ...
                  <div class="d-flex justify-space-between flex-wrap gap-y-4">
                    <div
                      v-for="(item, index) in [
                        ...
                        { title: 'Phone', icon: 'tabler-phone-call', color: 'success', value: '800-GO-DRIVE' },
                      ]"
                      :key="index"
                    ...
                    <div class="d-flex gap-x-3 align-center mb-4">
                      <VAvatar
                        color="success"
                        variant="tonal"
                      >
          ...
          >
            <VCard>
              ...
              <VCardText>
                <p class="mb-6">
                  Completa el formulario y nos pondremos en contacto contigo lo más rápido posible.
                </p>
